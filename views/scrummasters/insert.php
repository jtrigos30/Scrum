<?php require "views/shared/header.php" ?>
  ...
  <div class="container">
    ...
    <form action="index.php?controlador=scrummaster&accion=store" method="post">
      <div class="form-floating mb-3">
        <input type="text" class="form-control" id="certificado" name="certificado" placeholder="certificado">
