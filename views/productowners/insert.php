<?php require "views/shared/header.php" ?>
  ...
  <div class="container">
    ...
    <form action="index.php?controlador=productowner&accion=store" method="post">
      <div class="form-floating mb-3">
        <input type="text" class="form-control" id="experiencia" name="experiencia" placeholder="experiencia">
