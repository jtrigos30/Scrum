<?php require "views/shared/header.php" ?>
  ...
  <div class="container">
    ...
    <input type="hidden" name="idDevelop" value="<?= $data['idDevelop'] ?>">
      <div class="form-floating mb-3">
        <input type="text" class="form-control" id="habilidad" name="habilidad" placeholder="habilidad" value="<?= $data['desarrollador']['habilidad'] ?>">
